...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  // https://cdn.staticaly.com/gh/15932861067/image@main/images/
...
<details class="folding-tag" cyan><summary> 查看二次元背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/default_cover_7.webp)" class="imgbox" onclick="changeBg('url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/default_cover_7.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/dm1.webp)" class="imgbox" onclick="changeBg('url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/dm1.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/dm2.webp)" class="imgbox" onclick="changeBg('url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/dm2.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/home_bg.webp)" class="imgbox" onclick="changeBg('url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/home_bg.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/yuanshen1.webp)" class="imgbox" onclick="changeBg('url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/yuanshen1.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/default_cover_135.webp)" class="imgbox" onclick="changeBg('url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/default_cover_135.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/default_cover_142.webp)" class="imgbox" onclick="changeBg('url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/default_cover_142.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/default_cover_143.webp)" class="imgbox" onclick="changeBg('url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/default_cover_143.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/default_cover_145.webp)" class="imgbox" onclick="changeBg('url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/default_cover_145.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看风景背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/default_cover_147.webp)" class="imgbox" onclick="changeBg('url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/default_cover_147.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/default_cover_148.webp)" class="imgbox" onclick="changeBg('url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/default_cover_148.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/default_cover_149.webp)" class="imgbox" onclick="changeBg('url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/default_cover_149.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/default_cover_150.webp)" class="imgbox" onclick="changeBg('url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/default_cover_150.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/default_cover_151.webp)" class="imgbox" onclick="changeBg('url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/default_cover_151.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/default_cover_152.webp)" class="imgbox" onclick="changeBg('url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/default_cover_152.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/default_cover_153.webp)" class="imgbox" onclick="changeBg('url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/default_cover_153.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/default_cover_154.webp)" class="imgbox" onclick="changeBg('url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/default_cover_154.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看萌宠背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/wallpaper_cover.webp)" class="imgbox" onclick="changeBg('url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/wallpaper_cover.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看适配手机的背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/mb2.webp)" class="pimgbox" onclick="changeBg('url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/mb2.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/mb4.webp)" class="pimgbox" onclick="changeBg('url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/mb4.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/mb5.webp)" class="pimgbox" onclick="changeBg('url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/mb5.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/mb13.webp)" class="pimgbox" onclick="changeBg('url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/mb13.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/mb14.webp)" class="pimgbox" onclick="changeBg('url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/mb14.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/mb15.webp)" class="pimgbox" onclick="changeBg('url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/mb15.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/mb16.webp)" class="pimgbox" onclick="changeBg('url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/mb16.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/mb17.webp)" class="pimgbox" onclick="changeBg('url(https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/mb17.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 设置自定义背景 </summary>
              <div class='content'>
              <p><center><input type="text" id="pic-link" size="70%" maxlength="1000" placeholder="请输入有效的图片链接，如 https://aki-bucket.oss-cn-beijing.aliyuncs.com/img/home_bg.webp"></center></p><p><center><button type="button" onclick="getPicture()" style="background:var(--theme-color);width:35%;padding: 5px 0px 7px 0px;border-radius:30px;color:white;line-height:2;">🌈切换背景🌈</button></center></p>
              </div>
            </details>
